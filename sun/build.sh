...
i686-elf-gcc -c os/print.c -o bin/print.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra
...
i686-elf-gcc -T linker.ld -o bin/sun.bin -ffreestanding -O2 -nostdlib bin/boot.o bin/kernel.o bin/print.o bin/log.o -lgcc
