...
x86_64-elf-gcc -I ~/opt/cross/lib/gcc/x86_64-elf/15.1.0/include -ffreestanding -Wall -Werror -m64 -nostdlib -nostdinc -fno-pie -fno-pic -fno-stack-protector -mno-red-zone -c init/init.c -o compiled/init.o
