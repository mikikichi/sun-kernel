...
void sys_error(const char* message) {
    printcolour(VGA_COLOUR_RED, VGA_COLOUR_BLACK);
    print("[ERROR] ");
    print(message);
    printcolour(VGA_COLOUR_LIGHT_GRAY, VGA_COLOUR_BLACK);
}

void sys_warn(const char* message) {
    printcolour(VGA_COLOUR_LIGHT_BROWN, VGA_COLOUR_BLACK);
    print("[WARNING] ");
    print(message);
    printcolour(VGA_COLOUR_LIGHT_GRAY, VGA_COLOUR_BLACK);
}
...
void sys_info(const char* message) {
    printcolour(VGA_COLOUR_BLUE, VGA_COLOUR_BLACK);
    print("[INFO] ");
    print(message);
    printcolour(VGA_COLOUR_LIGHT_GRAY, VGA_COLOUR_BLACK);
}
